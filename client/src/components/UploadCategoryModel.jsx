        ...
        <section className='fixed top-0 bottom-0 left-0 right-0 p-4 bg-neutral-500 z-50 bg-opacity-60 flex items-center justify-center'>
            <div className='bg-white max-w-4xl w-full p-4 rounded'>
                ...
                <form className='my-3 grid gap-2' onSubmit={handleSubmit} >
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='flex gap-4 flex-col lg:flex-row items-center'>
                            ...
                            <label htmlFor='uploadCategoryImage'>
                                <div  className={`
                                    ${data.name ? "bg-amber-300 hover:amber-400" : "bg-gray-200"}  
                    ...
                    <button className={`${!(data.name && data.image) || loading ? "bg-gray-200" : "bg-amber-300 hover:bg-amber-400 "} py-2 font-semibold`}>
