...
const EditSubCategory = ({close, editAbleData, fetchData}) => {
            ...
            <form className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='flex flex-col lg:flex-row items-center gap-3'>
                            ...
                            <label htmlFor='uploadSubCategoryImage'>
                                <div className={`
                                    ${subCategoryData.name ? "bg-amber-300 hover:amber-400" : "bg-gray-200"}  
                    ...
                    <button
                        className={`px-4 py-2 border
                            ${subCategoryData?.name && subCategoryData?.image && subCategoryData?.category[0] ? "bg-amber-300 hover:bg-amber-400" : "bg-gray-200"}    
                            font-semibold
                        `}
                    >
                        Update
