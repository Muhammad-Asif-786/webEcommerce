...
const Product = () => {
  ...
  useEffect(()=>{
    let flag = true //Jab user search box mein type karta hai → har keyboard ke character par API call na ho.User 300ms tak type karna band kare → tab API call chale
  ...
  return (
    <section className=''>
        <div className=' mt-25 p-2  bg-white shadow-md flex items-center justify-between gap-4'>
