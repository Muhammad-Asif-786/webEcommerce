...
const ProductDisplayPage = () => {
  const params = useParams()
    // split("-") - ki basis py torna.
  // Negative index -1 hamesha last item ko refer karta hai.
  // Agar aap .slice(-2) karte → last 2 elements milte.
  // Agar aap .slice(1) karte → first element ke baad ka array milta.
  ...
  const fetchProductDetails = async()=>{
    try {
      setLoading(true)
        ...
        // const { data : responseData } = response // indono mn sy ap koi bhi use kar sakty ho
        const responseData = response?.data;   // ya zada professional hy
 ...
 {/*  }, [productId]) */} //ya zada better/professional hy kiunky ❓ Is array me params ki jagah kya aa sakta hai? Is array ke andar hamesha wo values likhte hain jinke change hone par useEffect chalana ho. 
